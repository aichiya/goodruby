...
extern const u8 gInterfaceGfx_AquaBall[];
extern const u8 gInterfacePal_AquaBall[];
extern const u8 gInterfaceGfx_MagmaBall[];
extern const u8 gInterfacePal_MagmaBall[];
...
extern const u8 gBerryPic_Occa[];
extern const u8 gBerryPic_Passho[];
extern const u8 gBerryPic_Wacan[];
extern const u8 gBerryPic_Rindo[];
extern const u8 gBerryPic_Yache[];
extern const u8 gBerryPic_Chople[];
extern const u8 gBerryPic_Kebia[];
extern const u8 gBerryPic_Shuca[];
extern const u8 gBerryPic_Coba[];
extern const u8 gBerryPic_Payapa[];
extern const u8 gBerryPic_Tanga[];
extern const u8 gBerryPic_Charti[];
extern const u8 gBerryPic_Kasib[];
extern const u8 gBerryPic_Haban[];
extern const u8 gBerryPic_Colbur[];
extern const u8 gBerryPic_Babiri[];
extern const u8 gBerryPic_Chilan[];
extern const u8 gBerryPic_Roseli[];
...
extern const u8 gBerryPalette_Occa[];
extern const u8 gBerryPalette_Passho[];
extern const u8 gBerryPalette_Wacan[];
extern const u8 gBerryPalette_Rindo[];
extern const u8 gBerryPalette_Yache[];
extern const u8 gBerryPalette_Chople[];
extern const u8 gBerryPalette_Kebia[];
extern const u8 gBerryPalette_Shuca[];
extern const u8 gBerryPalette_Coba[];
extern const u8 gBerryPalette_Payapa[];
extern const u8 gBerryPalette_Tanga[];
extern const u8 gBerryPalette_Charti[];
extern const u8 gBerryPalette_Kasib[];
extern const u8 gBerryPalette_Haban[];
extern const u8 gBerryPalette_Colbur[];
extern const u8 gBerryPalette_Babiri[];
extern const u8 gBerryPalette_Chilan[];
extern const u8 gBerryPalette_Roseli[];
...
extern const u8 gBattleAnimSpriteSheet_292[];
...
extern const u8 gBattleAnimSpritePalette_289[];
extern const u8 gBattleAnimSpritePalette_290[];
extern const u8 gBattleAnimSpritePalette_291[];
extern const u8 gBattleAnimSpritePalette_293[];
extern const u8 gBattleAnimSpritePalette_294[];
extern const u8 gBattleAnimSpritePalette_295[];
extern const u8 gBattleAnimSpritePalette_296[];
extern const u8 gBattleAnimSpritePalette_297[];
extern const u8 gBattleAnimSpritePalette_298[];
extern const u8 gBattleAnimSpritePalette_299[];
extern const u8 gBattleAnimSpritePalette_300[];
extern const u8 gBattleAnimSpritePalette_302[];
extern const u8 gBattleAnimSpritePalette_303[];
