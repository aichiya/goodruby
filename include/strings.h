...
extern const u8 gDexText_Abilities[];
extern const u8 gDexText_AbilityOne[];
extern const u8 gDexText_AbilityTwo[];
extern const u8 gDexText_AbilityHidden[];
extern const u8 gDexText_BaseHP[];
extern const u8 gDexText_BaseAtk[];
extern const u8 gDexText_BaseDef[];
extern const u8 gDexText_BaseSAtk[];
extern const u8 gDexText_BaseSDef[];
extern const u8 gDexText_BaseSpeed[];
extern const u8 gDexText_DoesNotEvolve[];
extern const u8 gDexText_EvolvesInto[];
extern const u8 gDexText_MayEvolveInto[];
extern const u8 gDexText_AtLevel[];
extern const u8 gDexText_Using[];
extern const u8 gDexText_WhenFriendly[];
extern const u8 gDexText_WhenBeautiful[];
extern const u8 gDexText_IfMale[];
extern const u8 gDexText_IfFemale[];
extern const u8 gDexText_Appears[];
extern const u8 gDexText_EeveeEvo[];
extern const u8 gDexText_TyrogueEvo[];
extern const u8 gDexText_TyrogueEvo2[];
...
extern const u8 OtherText_SwitchAbility[];
extern const u8 OtherText_AbilityBecame[];
...
extern const u8 gOtherText_Balance[];
...
extern const u8 gOtherText_PowerShort[];
extern const u8 gOtherText_AccShort[];
extern const u8 gOtherText_ClassShort[];
extern const u8 gOtherText_PhysicalShort[];
extern const u8 gOtherText_SpecialShort[];
extern const u8 gOtherText_StatusShort[];
...
extern const u8 OtherText_Quiz111[];
extern const u8 OtherText_Quiz112[];
extern const u8 OtherText_Quiz113[];
extern const u8 OtherText_Quiz121[];
extern const u8 OtherText_Quiz122[];
extern const u8 OtherText_Quiz123[];
extern const u8 OtherText_Quiz131[];
extern const u8 OtherText_Quiz132[];
extern const u8 OtherText_Quiz133[];
extern const u8 OtherText_Quiz211[];
extern const u8 OtherText_Quiz212[];
extern const u8 OtherText_Quiz213[];
extern const u8 OtherText_Quiz221[];
extern const u8 OtherText_Quiz222[];
extern const u8 OtherText_Quiz223[];
extern const u8 OtherText_Quiz231[];
extern const u8 OtherText_Quiz232[];
extern const u8 OtherText_Quiz233[];
extern const u8 OtherText_Quiz311[];
extern const u8 OtherText_Quiz312[];
extern const u8 OtherText_Quiz313[];
extern const u8 OtherText_Quiz321[];
extern const u8 OtherText_Quiz322[];
extern const u8 OtherText_Quiz323[];
extern const u8 OtherText_Quiz331[];
extern const u8 OtherText_Quiz332[];
extern const u8 OtherText_Quiz333[];
extern const u8 OtherText_Quiz411[];
extern const u8 OtherText_Quiz412[];
extern const u8 OtherText_Quiz413[];
extern const u8 OtherText_Quiz421[];
extern const u8 OtherText_Quiz422[];
extern const u8 OtherText_Quiz423[];
extern const u8 OtherText_Quiz431[];
extern const u8 OtherText_Quiz432[];
extern const u8 OtherText_Quiz433[];
extern const u8 OtherText_Quiz511[];
extern const u8 OtherText_Quiz512[];
extern const u8 OtherText_Quiz513[];
extern const u8 OtherText_Quiz514[];
extern const u8 OtherText_Quiz521[];
extern const u8 OtherText_Quiz522[];
extern const u8 OtherText_Quiz523[];
extern const u8 OtherText_Quiz524[];
extern const u8 OtherText_Quiz531[];
extern const u8 OtherText_Quiz532[];
extern const u8 OtherText_Quiz533[];
extern const u8 OtherText_Quiz534[];
...
extern const u8 OtherText_Meowth[];
extern const u8 OtherText_Spheal[];
extern const u8 OtherText_Jigglypuff[];
extern const u8 OtherText_Eevee[];
extern const u8 OtherText_Porygon[];
...
extern const u8 OtherText_FireStone[];
extern const u8 OtherText_WaterStone[];
extern const u8 OtherText_ThunderStone[];
extern const u8 OtherText_LeafStone[];
extern const u8 OtherText_MoonStone[];
extern const u8 OtherText_SunStone[];
extern const u8 OtherText_DawnStone[];
extern const u8 OtherText_DuskStone[];
extern const u8 OtherText_ShinyStone[];
extern const u8 OtherText_IceStone[];
