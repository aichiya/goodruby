...
Move_FLAME_CHARGE:
	...
	createvisualtask AnimTask_BlendMonInAndOut, 3, ANIM_BANK_ATTACKER, 31, 8, 2, 3
...
Move_INCINERATE:
	...
	panse_1B SE_W053, 192, 63, 2, 0
	call _Incinsubcall
	createvisualtask AnimTask_ShakeMon, 5, ANIM_BANK_TARGET, 3, 0, 43, 1
	createvisualtask AnimTask_ShakeMon, 5, ANIM_BANK_DEF_PARTNER, 3, 0, 43, 1
	call _Incinsubcall
	call _Incinsubcall
	call _Incinsubcall
	waitforvisualfinish
...
Move_EARTH_BLADES:
	...
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_BANK_TARGET, 3, 0, 8, 1
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_BANK_DEF_PARTNER, 3, 0, 8, 1
	waitforvisualfinish
	createsprite gSlideMonToOriginalPosSpriteTemplate, 2, 0, 0, 7
	waitforvisualfinish
