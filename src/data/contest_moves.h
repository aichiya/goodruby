...
const struct ContestMove gContestMoves[] = {
    ...
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_BEAUTY, 0, {COMBO_STARTER_CALM_MIND, 0, 0, 0}}, // PSYCHO_BOOST
    ...
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // DUAL_CHOP
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // X_SCISSOR
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // FLAME_BURST
    {CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // FLAME_CHARGE
    ...
    {CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // PLAY_ROUGH
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // SNARL
    ...
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // PUPPY_EYES
    ...
    {CONTEST_EFFECT_BETTER_IF_SAME_TYPE, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // VENOSHOCK
    {CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // QUIVER_DANCE
    ...
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // LEAF_TORNADO
    {CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // HURRICANE
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // SHADOW_SNEAK
    {CONTEST_EFFECT_AVOID_STARTLE, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // PHANTOM_FORCE
    ...
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // DISARM_VOICE
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONES, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // DRAIN_KISS
    ...
    {CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // STORED_POWER
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // CAPTIVATE
    {CONTEST_EFFECT_EXCITE_AUDIENCE_IN_ANY_CONTEST, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // HEAL_PULSE
    ...
    {CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // STICKY_WEB
    ...
    {CONTEST_EFFECT_EXCITE_AUDIENCE_IN_ANY_CONTEST, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // CHIP_AWAY
    ...
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // ECHOED_VOICE
    {CONTEST_EFFECT_BETTER_IF_SAME_TYPE, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // SYNCHRONOISE
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // BOOMBURST
    ...
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // HEAVY_SLAM
    {CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // AQUA_RING
    {CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // SOAK
    ...
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // BULLDOZE
    ...
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // STEAMROLLER
    ...
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // ACID_SPRAY
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // HEX
    {CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // SLUDGE_WAVE
    {CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // WRING_OUT
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // REFLECT_TYPE
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // SHADOW_CLAW
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONE, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // FOUL_PLAY
    ...
    {CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // AUTOTOMIZE
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // METAL_BURST
    {CONTEST_EFFECT_STARTLE_PREV_MON, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // LOW_SWEEP
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // WILD_CHARGE
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // NUZZLE
    {CONTEST_EFFECT_BETTER_WHEN_AUDIENCE_EXCITED, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // PLAY_NICE
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // ELECTRO_BALL
    {CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // ENTRAINMENT
    {CONTEST_EFFECT_BETTER_WHEN_LATER, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // TRUMP_CARD
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // STRUGGLE_BUG
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // INFESTATION
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // PETAL_STORM
    {CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // GUNK_SHOT
    {CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // VENOM_DRENCH
    {CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // BELCH
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // LAVA_PLUME
    {CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // INCINERATE
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // CLEAR_SMOG
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // SHELL_SMASH
    {CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // INFERNO
    ...
    {CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // PSYSHOCK
    ...
    {CONTEST_EFFECT_NEXT_APPEAL_LATER, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // DRAGON_TAIL
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // DRAGON_RUSH
    {CONTEST_EFFECT_AVOID_STARTLE, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // SPIKY_SHIELD
    {CONTEST_EFFECT_AVOID_STARTLE, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // COTTON_GUARD
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // DRAGON_PULSE
    {CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // HONE_CLAWS
    {CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // COIL
    {CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // EERIE_IMPULSE
    ...
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // NOBLE_ROAR
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // RAZOR_SHELL
    {CONTEST_EFFECT_BETTER_IF_SAME_TYPE, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // POWER_TRICK
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONES, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // POWER_SPLIT
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONES, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // GUARD_SPLIT
    {CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // SPOTLIGHT
    ...
    {CONTEST_EFFECT_STARTLE_PREV_MONS, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // BRUTAL_SWING
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // GIGA_IMPACT
    {CONTEST_EFFECT_EXCITE_AUDIENCE_IN_ANY_CONTEST, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // STORM_THROW
    {CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // DRILL_RUN
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // ICE_SHARD
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // FROST_BREATH
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // FREEZE_DRY
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // HEAD_SMASH
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // HEART_STAMP
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // BULLET_PUNCH
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // ORIGIN_PULSE
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // EARTH_BLADES
    {CONTEST_EFFECT_BETTER_IF_LAST, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // ICICLE_CRASH
    ...
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // WORK_UP
    {CONTEST_EFFECT_BETTER_IF_FIRST, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // AURA_SPHERE
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // PSYSTRIKE
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // U_TURN
    {CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // ACROBATICS
    {CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONE, CONTEST_CATEGORY_TOUGH, 0, {COMBO_STARTER_BELLY_DRUM, 0, 0, 0}}, // DRAIN_PUNCH
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // FOCUS_BLAST
    {CONTEST_EFFECT_AVOID_STARTLE, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // AURORA_VEIL
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // VOLT_SWITCH
    {CONTEST_EFFECT_HIGHLY_APPEALING, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // MAGIC_GLEAM
    ...
    {CONTEST_EFFECT_BETTER_WHEN_AUDIENCE_EXCITED, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // FELL_STINGER
    {CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // FINAL_GAMBIT
    {CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // LAST_RESORT
    {CONTEST_EFFECT_NEXT_APPEAL_LATER, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // CIRCLE_THROW
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // MYSTIC_FIRE
    {CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // ROCK_WRECKER
    {CONTEST_EFFECT_STARTLE_FRONT_MON, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // HORSEPOWER
    {CONTEST_EFFECT_DONT_EXCITE_AUDIENCE, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // RAGE_POWDER
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // BURN_UP
    {CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // TEARFUL_LOOK
    {CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // TOXIC_THREAD
    {CONTEST_EFFECT_BETTER_IF_SAME_TYPE, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // ROUND
    {CONTEST_EFFECT_EXCITE_AUDIENCE_IN_ANY_CONTEST, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // SACRED_SWORD
    {CONTEST_EFFECT_USER_MORE_EASILY_STARTLED, CONTEST_CATEGORY_BEAUTY, 0, {0, 0, 0, 0}}, // DRACO_METEOR
    {CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS, CONTEST_CATEGORY_SMART, COMBO_STARTER_HYPNOSIS, {0, 0, 0, 0}}, // DARK_VOID
    {CONTEST_EFFECT_NEXT_APPEAL_EARLIER, CONTEST_CATEGORY_COOL, 0, {0, 0, 0, 0}}, // ACCELEROCK
    {CONTEST_EFFECT_REPETITION_NOT_BORING, CONTEST_CATEGORY_CUTE, 0, {0, 0, 0, 0}}, // DEMON_BOOK
    {CONTEST_EFFECT_NEXT_APPEAL_LATER, CONTEST_CATEGORY_TOUGH, 0, {0, 0, 0, 0}}, // AQUA_SUPLEX
    {CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES, CONTEST_CATEGORY_SMART, 0, {0, 0, 0, 0}}, // FORCEWIN
};
