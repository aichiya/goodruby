...
static const u8 DexDescription_Ampharos_1[] = _(
  "Ampahros gives off so much light that\n"
...
static const u8 DexDescription_Wobbuffet_1[] = _(
  "Wobuffet does nothing but endure\n"
...
#else
static const u8 DexDescription_Wobbuffet_1[] = _(
  "If two or more Pokémon meet, they will\n"
...
static const u8 DexDescription_Budew_1[] = _(
  "It lives alongside clear ponds. In the\n"
  "winter, it closes its bud and endures\n"
  "the cold.");
static const u8 DexDescription_Budew_2[] = _(
  "When spring arrives, the bud scatters\n"
  "pollen that induces harsh sneezing and\n"
  "runny noses.");

static const u8 DexDescription_Roserade_1[] = _(
  "The thorns in its hands each contain\n"
