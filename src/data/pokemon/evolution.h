...
struct Evolution gEvolutionTable[NUM_SPECIES][8] =
{
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_STEELIX}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_SCIZOR}},
    ...
    [SPECIES_SPHEAL]     = {{EVO_LEVEL, 21, SPECIES_SEALEO}},
    ...
    [SPECIES_HAPPINY]    = {{EVO_FRIENDSHIP, 0, SPECIES_CHANSEY},
                            {EVO_LEVEL, 15, SPECIES_CHANSEY}},
    [SPECIES_MUNCHLAX]   = {{EVO_FRIENDSHIP, 0, SPECIES_SNORLAX},
                            {EVO_LEVEL, 40, SPECIES_SNORLAX}},
    [SPECIES_MANTYKE]    = {{EVO_PARTY_MEMBER, SPECIES_REMORAID, SPECIES_MANTINE}},
    [SPECIES_SNEASEL]    = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_WEAVILE}},
    [SPECIES_MAGNETON]   = {{EVO_MAGNETISM, 0, SPECIES_MAGNEZONE}},
    [SPECIES_LICKITUNG]  = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_RHYDON]     = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_RHYPERIOR}},
    [SPECIES_TANGELA]    = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH}},
    [SPECIES_ELECTABUZZ] = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]     = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_MAGMORTAR}},
    [SPECIES_TOGETIC]    = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_TOGEKISS}},
    [SPECIES_YANMA]      = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_YANMEGA}},
    [SPECIES_GLIGAR]     = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_GLISCOR}},
    [SPECIES_PILOSWINE]  = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE}},
    [SPECIES_PORYGON2]   = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_PORYGONZ}},
    [SPECIES_NOSEPASS]   = {{EVO_MAGNETISM, 0, SPECIES_PROBOPASS}},
    [SPECIES_DUSCLOPS]   = {{EVO_ITEM, ITEM_NOBLE_STONE, SPECIES_DUSKNOIR}},
