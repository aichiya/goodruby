...
struct Evolution gEvolutionTable[NUM_SPECIES][8] =
{
    ...
    [SPECIES_MISDREAVUS] = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_MISMAGIUS}},
    [SPECIES_MURKROW]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_HONCHKROW}},
    ...
    [SPECIES_MUNCHLAX]   = {{EVO_FRIENDSHIP, 40, SPECIES_SNORLAX}},
    [SPECIES_MANTYKE]    = {{EVO_LEVEL, 30, SPECIES_MANTINE}},
    [SPECIES_SNEASEL]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_WEAVILE}},
    [SPECIES_MAGNETON]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_MAGNEZONE}},
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 30, SPECIES_LICKILICKY}},
    [SPECIES_RHYDON]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_RHYPERIOR}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 30, SPECIES_TANGROWTH}},
    [SPECIES_ELECTABUZZ] = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_MAGMORTAR}},
    [SPECIES_TOGETIC]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_TOGEKISS}},
    [SPECIES_YANMA]      = {{EVO_LEVEL, 30, SPECIES_YANMEGA}},
    [SPECIES_GLIGAR]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_GLISCOR}},
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL, 30, SPECIES_MAMOSWINE}},
    [SPECIES_PORYGON2]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_PORYGONZ}},
    [SPECIES_NOSEPASS]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_PROBOPASS}},
    [SPECIES_DUSCLOPS]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_DUSKNOIR}},
