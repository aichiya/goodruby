...
const u8 gInterfaceGfx_AquaBall[] = INCBIN_U8("graphics/interface/ball/aqua.4bpp.lz");
const u8 gInterfacePal_AquaBall[] = INCBIN_U8("graphics/interface/ball/aqua.gbapal.lz");
const u8 gInterfaceGfx_MagmaBall[] = INCBIN_U8("graphics/interface/ball/magma.4bpp.lz");
const u8 gInterfacePal_MagmaBall[] = INCBIN_U8("graphics/interface/ball/magma.gbapal.lz");
// Sport, Park, Dream, and Beast ball assets exists but are unused.
...
const u8 gBattleAnimSpriteSheet_Particles2[] = INCBIN_U8("graphics/battle_anims/sprites/particles2.4bpp.lz");
...
const u8 gBattleAnimBackgroundImageSludgeWave_Pal[] = INCBIN_U8("graphics/battle_anims/backgrounds/water_sludge.gbapal.lz");
...
const u8 gBattleAnimSpriteSheet_292[] = INCBIN_U8("graphics/battle_anims/sprites/292.4bpp.lz");
const u8 gBattleAnimSpriteSheet_297[] = INCBIN_U8("graphics/battle_anims/sprites/297.4bpp.lz");
const u8 gBattleAnimSpriteSheet_301[] = INCBIN_U8("graphics/battle_anims/sprites/301.4bpp.lz");
const u8 gBattleAnimSpriteSheet_303[] = INCBIN_U8("graphics/battle_anims/sprites/303.4bpp.lz");
const u8 gBattleAnimSpriteSheet_307[] = INCBIN_U8("graphics/battle_anims/sprites/307.4bpp.lz");
const u8 gBattleAnimSpriteSheet_308[] = INCBIN_U8("graphics/battle_anims/sprites/308.4bpp.lz");
const u8 gBattleAnimSpritePalette_289[] = INCBIN_U8("graphics/battle_anims/sprites/289.gbapal.lz");
const u8 gBattleAnimSpritePalette_290[] = INCBIN_U8("graphics/battle_anims/sprites/290.gbapal.lz");
const u8 gBattleAnimSpritePalette_291[] = INCBIN_U8("graphics/battle_anims/sprites/291.gbapal.lz");
const u8 gBattleAnimSpritePalette_293[] = INCBIN_U8("graphics/battle_anims/sprites/293.gbapal.lz");
const u8 gBattleAnimSpritePalette_294[] = INCBIN_U8("graphics/battle_anims/sprites/294.gbapal.lz");
const u8 gBattleAnimSpritePalette_295[] = INCBIN_U8("graphics/battle_anims/sprites/295.gbapal.lz");
const u8 gBattleAnimSpritePalette_296[] = INCBIN_U8("graphics/battle_anims/sprites/296.gbapal.lz");
const u8 gBattleAnimSpritePalette_297[] = INCBIN_U8("graphics/battle_anims/sprites/297.gbapal.lz");
const u8 gBattleAnimSpritePalette_298[] = INCBIN_U8("graphics/battle_anims/sprites/298.gbapal.lz");
const u8 gBattleAnimSpritePalette_299[] = INCBIN_U8("graphics/battle_anims/sprites/299.gbapal.lz");
...
const u8 gBattleAnimSpritePalette_305[] = INCBIN_U8("graphics/battle_anims/sprites/305.gbapal.lz");
const u8 gBattleAnimSpritePalette_306[] = INCBIN_U8("graphics/battle_anims/sprites/306.gbapal.lz");
const u8 gBattleAnimSpritePalette_308[] = INCBIN_U8("graphics/battle_anims/sprites/308.gbapal.lz");
