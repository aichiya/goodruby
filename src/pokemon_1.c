...
void GiveBoxMonInitialMoveset(struct BoxPokemon *boxMon)
{
    ...
    for (i = 0; gLevelUpLearnsets[species][i] != (u32)-1; i++)
    {
        u16 moveLevel;
        u16 move;
        ...
        move = (gLevelUpLearnsets[species][i] & 0xFFFF);
...
u16 MonTryLearningNewMove(struct Pokemon *mon, bool8 firstMove)
{
    ...
    if (firstMove)
    {
        ...
        while ((gLevelUpLearnsets[species][sLearningMoveTableID] >> 16) != (level))
        {
            ...
            if (gLevelUpLearnsets[species][sLearningMoveTableID] == 0xFFFFFFFF)
                return 0;
        }
    }

    if ((gLevelUpLearnsets[species][sLearningMoveTableID] >> 16) == (level))
    {
        gMoveToLearn = (gLevelUpLearnsets[species][sLearningMoveTableID] & 0xFFFF);
        sLearningMoveTableID++;
