...
const u16 TMHMMoves[] =
{
    ...
    MOVE_GIGA_IMPACT,
    MOVE_ROCK_POLISH,
    MOVE_SPLASH, // Aurora Veil
    MOVE_STONE_EDGE,
    MOVE_SPLASH, // Volt Switch
    MOVE_THUNDER_WAVE,
    MOVE_WILD_CHARGE,
    MOVE_SWORDS_DANCE,
    MOVE_STEALTH_ROCK,
    ...
    MOVE_NATURAL_GIFT,
    MOVE_POISON_JAB,
    MOVE_SPLASH, // Dazzling Gleam
    MOVE_SPLASH, // Grass Knot
    MOVE_SIGNAL_BEAM,
    MOVE_SLEEP_TALK,
    MOVE_U_TURN,
    MOVE_SUBSTITUTE,
    MOVE_FLASH_CANNON,
    MOVE_SPLASH, // Trick Room
    MOVE_CUT,
    MOVE_FLY,
    MOVE_SURF,
    MOVE_STRENGTH,
