...
extern const u8 gBattleAnimSpritePalette_293[];
extern const u8 gBattleAnimSpritePalette_294[];
...
void do_ominous_dust(u8 taskId)
{
    struct Struct_sub_8078914 subStruct;
    int var0 = 0;
    ...
    LZDecompressVram(&gBattleAnimBackgroundTilemap_SandstormBrew, subStruct.field_4);
    LZDecompressVram(&gBattleAnimBackgroundImage_SandstormBrew, subStruct.field_0);
    LoadCompressedPalette(&gBattleAnimSpritePalette_294, subStruct.field_8 << 4, 32);
