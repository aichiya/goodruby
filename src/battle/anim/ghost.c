...
void InitAnimShadowBall(struct Sprite *sprite); //void sub_80DDF40(struct Sprite *sprite);
static void AnimShadowBallStep(struct Sprite *); //static void sub_80DDFE8(struct Sprite *);
...
void InitAnimShadowBall(struct Sprite *sprite)
{
    u16 r5, r6;
    r5 = sprite->pos1.x;
    r6 = sprite->pos1.y;
