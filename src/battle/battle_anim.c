...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    { (u8 *) &gBattleAnimSpriteSheet_163,  0x100, 10289 },
    { (u8 *) &gBattleAnimSpriteSheet_273,   0x20, 10290 },
    ...
    { (u8 *) &gBattleAnimSpriteSheet_297,  0x300, 10297 },
    { (u8 *) &gBattleAnimSpriteSheet_297,  0x300, 10298 },
    { (u8 *) &gBattleAnimSpriteSheet_297,  0x300, 10299 },
    { (u8 *) &gBattleAnimSpriteSheet_297,  0x300, 10300 },
    { (u8 *) &gBattleAnimSpriteSheet_301,  0x200, 10301 },
    { (u8 *) &gBattleAnimSpriteSheet_301,  0x200, 10301 },
    { (u8 *) &gBattleAnimSpriteSheet_303,  0x200, 10303 },
};
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    { (u8 *) &gBattleAnimSpritePalette_289, 10289 },
    { (u8 *) &gBattleAnimSpritePalette_290, 10290 },
    { (u8 *) &gBattleAnimSpritePalette_291, 10291 },
    { (u8 *) &gBattleAnimSpritePalette_290, 10292 },
    { (u8 *) &gBattleAnimSpritePalette_293, 10293 },
    { (u8 *) &gBattleAnimSpritePalette_294, 10294 },
    { (u8 *) &gBattleAnimSpritePalette_295, 10295 },
    { (u8 *) &gBattleAnimSpritePalette_296, 10296 },
    { (u8 *) &gBattleAnimSpritePalette_297, 10297 },
    { (u8 *) &gBattleAnimSpritePalette_298, 10298 },
    { (u8 *) &gBattleAnimSpritePalette_299, 10299 },
    { (u8 *) &gBattleAnimSpritePalette_300, 10300 },
    { (u8 *) &gBattleAnimSpritePalette_064, 10301 },
    { (u8 *) &gBattleAnimSpritePalette_302, 10302 },
    { (u8 *) &gBattleAnimSpritePalette_303, 10303 },
};
