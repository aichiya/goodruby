...
#define NAME_OCCA_BERRY    _("Occa")
#define NAME_PASSHO_BERRY  _("Passho")
#define NAME_WACAN_BERRY   _("Wacan")
#define NAME_RINDO_BERRY   _("Rindo")
#define NAME_YACHE_BERRY   _("Yache")
#define NAME_CHOPLE_BERRY  _("Chople")
#define NAME_KEBIA_BERRY   _("Kebia")
#define NAME_SHUCA_BERRY   _("Shuca")
#define NAME_COBA_BERRY    _("Coba")
#define NAME_PAYAPA_BERRY  _("Payapa")
#define NAME_TANGA_BERRY   _("Tanga")
#define NAME_CHARTI_BERRY  _("Charti")
#define NAME_KASIB_BERRY   _("Kasib")
#define NAME_HABAN_BERRY   _("Haban")
#define NAME_COLBUR_BERRY  _("Colbur")
#define NAME_BABIRI_BERRY  _("Babiri")
#define NAME_CHILAN_BERRY  _("Chilan")
#define NAME_ROSELI_BERRY  _("Roseli")
