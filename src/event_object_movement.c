...
#define EVENT_OBJ_PAL_TAG_27 0x111B
#define EVENT_OBJ_PAL_TAG_28 0x111C
#define EVENT_OBJ_PAL_TAG_29 0x111D
#define EVENT_OBJ_PAL_TAG_30 0x111E
#define EVENT_OBJ_PAL_TAG_31 0x111F
#define EVENT_OBJ_PAL_TAG_32 0x1120
#define EVENT_OBJ_PAL_TAG_33 0x1121
...
#define EVENT_OBJ_PAL_TAG_38 0x1126
#define EVENT_OBJ_PAL_TAG_39 0x1127
#define EVENT_OBJ_PAL_TAG_40 0x1128
#define EVENT_OBJ_PAL_TAG_41 0x1129
#define EVENT_OBJ_PAL_TAG_42 0x112A
#define EVENT_OBJ_PAL_TAG_43 0x112B
...
const struct SpritePalette sEventObjectSpritePalettes[] = {
    ...
    {gEventObjectPalette38, EVENT_OBJ_PAL_TAG_38},
    {gEventObjectPalette39, EVENT_OBJ_PAL_TAG_39},
    {gEventObjectPalette40, EVENT_OBJ_PAL_TAG_40},
    {gEventObjectPalette41, EVENT_OBJ_PAL_TAG_41},
    {gEventObjectPalette42, EVENT_OBJ_PAL_TAG_42},
    {gEventObjectPalette43, EVENT_OBJ_PAL_TAG_43},
    {NULL,                  0x0000},
};
...
u8 sub_805B410(u8 graphicsId, u8 b, s16 x, s16 y, u8 elevation, u8 direction)
{
    ...
    *(u16 *)&spriteTemplate.paletteTag = 0xFFFF;
    ...
    if (spriteId != MAX_SPRITES)
    {
        ...
        sprite->oam.paletteNum = LoadEventObjectPalette(graphicsInfo->paletteTag);
...
static void get_berry_tree_graphics(struct EventObject *eventObject, struct Sprite *sprite)
{
    ...
    if (berryStage != 0)
    {
        ...
        sprite->oam.paletteNum = LoadEventObjectPalette(gBerryTreePaletteSlotTablePointers[berryId][berryStage]);
...
u8 LoadEventObjectPalette(u16 paletteTag)
{
    ...
    {
        return sub_805BE58(&sEventObjectSpritePalettes[paletteSlot]);
    }
